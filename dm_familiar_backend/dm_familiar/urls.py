...
urlpatterns = [
    path('<str:uid>/project/', views.ProjectList.as_view()),
    path('<str:uid>/project/<str:ProjectId>', views.Project.as_view()),
    path('<str:uid>/project/<str:ProjectId>/book/list', views.BookList.as_view()),
    path('<str:uid>/project/<str:ProjectId>/book/<str:BookId>', views.Book.as_view()),
    path('<str:uid>/project/<str:ProjectId>/book/<str:BookId>/chapter/list', views.ChapterList.as_view()),
    path('<str:uid>/project/<str:ProjectId>/book/<str:BookId>/chapter/<str:ChapterId>', views.Chapter.as_view()),
